...
# ----------------- Config / utilidades -----------------
TOTAL_PREGUNTAS = 60  # ✅ Cambio principal: 40 -> 60
...
def _normalizar_respuestas(respuestas_dict):
    """Devuelve lista de 60 en formato texto ('Me encanta'/'Me interesa'/'No me gusta')
       o None si faltan/son inválidas."""  # ✅ Actualizado comentario
...
def _finalizar_y_predecir(test_instance: TestGrado10_11):
    ...
    ✅ FORMATO IGUAL AL GRADO 9 para compatibilidad con Flutter."""
    ...
    # Predicción (ahora con 60 respuestas)
    ...
    # ✅ FORMATO IGUAL AL TEST GRADO 9 (texto plano estructurado)
...
class TestGrado10_11ViewSet(viewsets.ModelViewSet):
    ...
    def iniciar(self, request):
        """Crea o recupera test en progreso para el usuario actual."""
        user = request.user
    ...
    def progreso(self, request, pk=None):
        """Actualiza respuestas de un test en progreso y calcula predicción si está completo."""
        user = request.user
        try:
